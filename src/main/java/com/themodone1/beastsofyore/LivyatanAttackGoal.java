...
public class LivyatanAttackGoal extends Goal {
    ...
    public boolean canUse() {
        ...
        boolean result = this.livyatan.getTarget() != null && this.livyatan.getTarget().isAlive();
...
//                this.livyatan.setDeltaMovement(this.livyatan.getDeltaMovement().add(0, 0.05D, 0));
//            }
...
//            Vec3 forward = Vec3.directionFromRotation(this.livyatan.getXRot(), this.livyatan.getYRot());
//            this.livyatan.setDeltaMovement(this.livyatan.getDeltaMovement().add(forward.scale(this.swimSpeed * 0.05D)));
//
//            if (this.livyatan.horizontalCollision) {
//
//                this.livyatan.setDeltaMovement(this.livyatan.getDeltaMovement().add(0, 0.05D, 0));
//            }
    ...
    private double getAttackAnimationStartDistance(LivingEntity target) {
        double Animreach = 14.0 + target.getBbWidth() + 2.0D;
